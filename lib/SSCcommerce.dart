...
class ssc_c extends StatefulWidget{
  const ssc_c({super.key});

  @override
  State<ssc_c> createState() => _JSCState();
}

class _JSCState extends State<ssc_c> {
            ...
            children:[
              ...
              DropdownButtonFormField<double>(
                decoration: const InputDecoration(
                  labelText: "Bangla" ,
                  labelStyle: TextStyle(color: Colors.brown,fontSize:17,) ,
              ...
              DropdownButtonFormField<double>(
                decoration: const InputDecoration(
                  labelText: "Business Entrepreneurship " ,
                  labelStyle: TextStyle(color: Colors.brown,fontSize:20,) ,
                  border: OutlineInputBorder(),
                ),
                value: 5.00,
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                      ...
                      child: const Text("Get GPA",style: TextStyle(color: Colors.brown,fontSize:20),)),
